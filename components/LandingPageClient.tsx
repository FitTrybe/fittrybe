          ...
          >
            ...
            >
              <div className="community-cta-wrapper" style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 16 }}>
                ...
                <a
                  href="https://chat.whatsapp.com/ITgYpQiAKssKgZcwqB0O8Q"
                  target="_blank"
    ...
    <footer style={{ background: "#0D0D0D", borderTop: "1px solid rgba(255,255,255,0.05)", padding: "40px 5vw" }}>
      <div className="footer-inner" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem" }} aria-label="Fittrybe social media links">
          {[
            { href: "https://wa.me/447424159414", Icon: IconWhatsApp, label: "Contact Fittrybe on WhatsApp" },
            { href: "https://www.instagram.com/fittrybe.uk/", Icon: IconInstagram, label: "Follow Fittrybe on Instagram" },
            { href: "https://www.facebook.com/fittrybe.uk", Icon: IconFacebook, label: "Follow Fittrybe on Facebook" },
            { href: "https://www.tiktok.com/@fittrybe", Icon: IconTiktok, label: "Follow Fittrybe on TikTok" },
          ].map(({ href, Icon, label }) => (
