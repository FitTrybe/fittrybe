...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/download`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/care-homes`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/sen-sessions`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/book-a-call`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
